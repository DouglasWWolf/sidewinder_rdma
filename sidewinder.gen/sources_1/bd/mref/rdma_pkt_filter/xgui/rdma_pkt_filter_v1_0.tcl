...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "RDMA_DEST_PORT" -parent ${Page_0}
...
proc update_PARAM_VALUE.RDMA_DEST_PORT { PARAM_VALUE.RDMA_DEST_PORT } {
	# Procedure called to update RDMA_DEST_PORT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RDMA_DEST_PORT { PARAM_VALUE.RDMA_DEST_PORT } {
	# Procedure called to validate RDMA_DEST_PORT
	return true
}
...
proc update_MODELPARAM_VALUE.RDMA_DEST_PORT { MODELPARAM_VALUE.RDMA_DEST_PORT PARAM_VALUE.RDMA_DEST_PORT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RDMA_DEST_PORT}] ${MODELPARAM_VALUE.RDMA_DEST_PORT}
}
